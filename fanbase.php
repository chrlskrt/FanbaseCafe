...
<!-- DELETE REPLY MODAL  -->
<div class="modal fade importantModal" tabindex="-2" data-bs-backdrop="static" role="dialog" id="deleteReplyModal">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-footer">
        ...
        <form method="POST" action="php/deleteReply.php">
            <input type="hidden" name="fanbase_id" value="<?php echo $fanbaseID ?>">
            <button id="btnDeleteReplyConfirm" type="submit" name="reply_id" value="" class="btn btn-danger"> Delete </button>
        </form>
      </div>
    </div>
  </div>
