    ...
    function getPosts($fanbase_id){
        ...
        if ($resultPosts){
            ...
            while ($row = $resultPosts->fetch_assoc()) {
                ...
                $row['post_created'] = date_format(date_create($row['post_created']), "M d, Y");
        ...
        foreach($fanbasePostsArr as $post){
            $posts .= '
                <div class="post" style="padding:30px; background-color:white; border-radius:10px">
                    <div style="display: flex; justify-content: space-between; gap:10px;">
                        <div style="display:flex; gap:10px">
                            <div class="p-2" style="display: flex; align-items: center">
                                <img src="https://ui-avatars.com/api/?rounded=true&name=' . $post['account_id']['username'] . '" alt="" class="profile-photo-sm">
                            </div>
                            <div class="">
                                <h2 style="margin-top:5px">' . $post['account_id']['username'] . '</h2>
                    ...
                    <div class="" style="display:flex; flex-direction:column; gap: 10px; margin-left: 90px">
